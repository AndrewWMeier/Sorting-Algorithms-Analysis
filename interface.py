...
class MergeSortGUI(tk.Tk):
    ...
    def create_widgets(self):
        ...
        #plot median  or average runtime or comparisons or max/min
        ttk.Label(self, text="Plot Type:").grid(row=3, column=0, padx=5, pady=5, sticky='e')
        self.plot_type_combobox = ttk.Combobox(self, values=["Average", "Median", "Comparisons", "Max/Min"], style='TCombobox')
        self.plot_type_combobox.set("Average")
